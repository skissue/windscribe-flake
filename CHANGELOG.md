...
All:
   ...
   * Fixed a height calculation error for error descriptions. #1560
Windows:
   * Fixed some Qt log spam. #1569
MacOS:
   * Fixed installer background does not show on macOS 26.2 Beta. #1539
Linux:
...
All:
   ...
   * Updated OpenVPN to 2.6.16. #1555
Windows:
...
MacOS:
   ...
   * Fixed the login username input box losing focus when using the trackpad. #1557
Linux:
   * Fixed tray icon bugs caused by refactor. #1541
...
All:
   ...
   * Fixed GUI misalignment and font when proxy gateway/secure hotspot are enabled. #1547
Windows:
...
All:
   ...
   * Fixed wsnet doesn't process DNS queries after a bit. #1496
Linux:
...
All:
   ...
   * Fixed GUI window not hidden correctly when transitioning. #1525
MacOS:
   ...
   * Fixed implementation of the WireGuard protocol. A rollback to the previous implementation. #1522
Linux:
...
All:
   ...
   * Fixed automatic connection mode does not try alternate datacenter server, if available, when first connection attempt fails. #1505
Windows:
...
MacOS:
   ...
   * Fixed erroneous assert in the debug log during GUI preferences output. #1494
Linux:
...
All:
   ...
   * Updated ctrld to 1.4.7. #1495
Windows:
   * Added preference for specifying the tray icon color. #1494
   * Fixed Internet connectivity detection in some cases. #1502
MacOS:
   * Fixed behaviour when menu bar icon is hidden via System Settings and app is docked. #1466
   * Fixed OpenVPN protocols not connecting due to script permission. #1499
Linux:
...
All:
   ...
   * Improved file organization of the project(refactoring). #888
Windows:
   ...
   * Removed deprecated use of wmic utility. #1482
MacOS:
...
All:
   ...
   * Updated ctrld to 1.4.6. #1464
Windows:
   * Fixed installer alert border. #1461
MacOS:
